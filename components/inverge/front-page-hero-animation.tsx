...
export function FrontPageHeroAnimation() {
  ...
  const reveal = (delay: number) => ({
    ...
    transition: { duration: 0.32, delay: reduceMotion ? 0 : delay, ease: "easeOut" },
  });
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-[color:var(--border-subtle)] bg-[color:var(--surface-elevated)] p-4 sm:p-6">
      <div className="space-y-4">
        ...
        <motion.div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4" {...reveal(0.04)}>
        ...
        <motion.div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4" {...reveal(0.16)}>
        ...
        <motion.div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4" {...reveal(0.28)}>
        ...
        <motion.div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4" {...reveal(0.4)}>
        ...
        <motion.div className="rounded-2xl border border-[color:var(--primary)] bg-[color:var(--surface)] p-4" {...reveal(0.52)}>
