...
There is then no dependency-ready successor: ULC-M1 remains blocked on its
independent S241A dependency, and no ULC stage starts automatically. An issue
state or issue closure cannot substitute for a required merge or receipt.
