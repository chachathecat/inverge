...
create or replace function public.c3r_p_find_record_v1(uuid, text, text, text, text, text)
returns uuid language sql stable security invoker set search_path = ''
as $$ select public.c3r_subject_find_record_v1('PRACTICE', $1, $2, $3, $4, $5, $6) $$;
...
create or replace function public.c3r_p_restore_record_v1(uuid, uuid)
returns jsonb language sql stable security invoker set search_path = ''
as $$ select public.c3r_subject_restore_record_v1('PRACTICE', $1, $2) $$;
...
create or replace function public.c3r_p_load_dashboard_v1(uuid, timestamptz)
returns jsonb language sql stable security invoker set search_path = ''
as $$ select public.c3r_subject_load_dashboard_v1('PRACTICE', $1, $2) $$;
...
create or replace function public.c3r_p_export_learner_data_v1(uuid)
returns jsonb language sql stable security invoker set search_path = ''
as $$ select public.c3r_subject_export_learner_data_v1('PRACTICE', $1) $$;
...
create or replace function public.c3r_p_delete_learner_data_v1(uuid)
returns jsonb language sql security invoker set search_path = ''
as $$ select public.c3r_subject_delete_learner_data_v1('PRACTICE', $1) $$;
