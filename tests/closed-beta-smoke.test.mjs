...
test("capture page contains capture+note framing copy", () => {
  ...
  ["오늘 학습 정리하기", "오늘 공부한 내용 또는 내 답안", "사진 찍기", "앨범에서 선택", "OCR 결과는 초안입니다", "저장하고 오늘 계획에 반영", "가장 큰 빈틈", "다음 행동"].forEach((phrase) => {
...
test("review queue keeps learner-visible capture loop proof copy", () => {
  ...
  ["오늘 한 것", "반복 신호와 최근 기록 기준", "다시 보기", "Capture에서 오늘 학습 1개를 저장하면 약점 후보와 다음 행동이 이곳에 이어집니다."].forEach((phrase) => {
