...
const BASE_SHA = "761b7f6b7648d19845ab3385665e92046165dddd";
const BASE_TREE = "c6c6a8ad876c2f40b5276a26485b088656addf49";
const CONFIG_PATH =
...
test("QFS3-CONTRACT-001 binds Issue #875, final base, APP-1 terminal receipt, and exactly six paths", () => {
  ...
  assert.equal(config.status, "final_source_only_candidate");
  ...
  assert.deepEqual(config.app1TerminalReceipt, {
    outcome: "APP1_BLOCKED",
    pullRequest: 876,
    headSha: "0685ae1266c842e7a3d03bef20ce4ba2369bf961",
    headTree: "42403b9d7fd8a242176a6089d33184a036a25b08",
    draft: true,
    merged: false,
    actionable: { p0: 0, p1: 1, p2: 0 },
  });
