...
test("Practice queue completion persists recalculation and keeps Theory semantics separate",async()=>{
 for(const action of ["second_calculation_retry","second_paragraph_rewrite"]){
  const f=fixture();await f.service.completeReview(OWNER_ID,"synthetic-owner@example.invalid","eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee",action,{recallOutcome:"fuzzy"});
...
test("Practice follow-up keeps the same subject and a recalculation action in Today",async()=>{
 const f=fixture();
 await f.service.completeReview(OWNER_ID,"synthetic-owner@example.invalid","eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee","second_calculation_retry",{recallOutcome:"fuzzy"});
