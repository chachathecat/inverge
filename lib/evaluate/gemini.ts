        ...
        parts: [
          {
            text: [
              ...
              "answerEvidenceQuote에는 finding이면 간극 판단의 근거, no_clear_gap이면 문제 요구를 충족하는 answerText의 실제 구절 1개를 4~120자로 그대로 인용한다. 바꾸거나 만들어내지 않는다. 근거 부족 또는 분석 실패로 인용할 구절이 없으면 빈 문자열로 쓴다.",
