...
import { validatePrivateReviewPacket } from "./private-review-packet.mjs";
...
/** Pure transformation, NOT approval. No answer is solved or rewritten here.
...
export function prepareEconomicsRuntimeCandidate(inputs) {
  ...
  validatePrivateReviewPacket(reviewSource, calculationSource);
