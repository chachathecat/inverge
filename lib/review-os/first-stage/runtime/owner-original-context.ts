import { ownerContentCatalogIds } from "./owner-content-registration.mjs";
...
import { isOwnerOriginalAdapter, ownerOriginalEnvironment, matchesOwnerOriginalReference } from "./owner-original-boundary";
...
export function authorizeOwnerOriginalCatalog(catalog: PrivateFirstStageCatalog, candidates: readonly QfI1CandidateV1[], assignableIds?: readonly string[]) {
  ...
  const allowed=ownerContentCatalogIds();
