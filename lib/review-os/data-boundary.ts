...
export const SAFE_DERIVED_SIGNAL_KEYS = [
  ...
  "todayPlanCandidateCount",
  "similarSchedulerId",
  "similarSchedulerStatus",
  "similarTaskId",
  "relatedQuestionId",
  ...
  "creditPackGrantId",
  "creditPackUnitsGranted",
  "creditPackUnitsAvailable",
  "usageIdempotencyKey",
  ...
  "costWarningState",
  "anomalyWarningState",
  "canonicalQuestionStatus",
  "sourceReviewId",
  "scoreLikeSummarySecondary",
  "terminalLearnerAction",
  "privateStorageRefsOnly",
  "calculatorModel",
  "rangeLowerDelta",
  "rangeUpperDelta",
  "taskHookKind",
