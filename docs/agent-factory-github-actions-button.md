...
- `target`: `auto`, a roadmap item id such as `S211`, a PR number such as `461`, or a sanitized fixture path.
...
S210 completion makes S211 the next ready example target for plan-only dispatch examples until the active roadmap advances again.
