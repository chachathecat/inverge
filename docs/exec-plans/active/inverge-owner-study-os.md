...
Dedicated issue #952. Actual Next.js normal-menu photo and two-page PDF manual-input runs now prove source preservation, explicit separation/confirmation, save and authenticated reconnect. SQL confirms both sources remain not-analyzed, with no generated notes or learning-record changes. The runs also exposed and fixed selected-subject loss during import and the non-persisted existing-answer entry choice. Seventeen focused tests and thirty-five related tests pass; native final-head validation and review remain pending. No personal/remote DB, source collection, provider, activation or Production changes. Final native checks, independent review and protected squash remain required.
