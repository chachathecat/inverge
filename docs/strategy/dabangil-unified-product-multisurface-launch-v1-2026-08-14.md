...
- Current candidate after terminal PR #764's exact-head merge and validated
  ...
  merge and validated receipt; no dependency-ready successor product stage
  because ULC-M1 additionally requires S241A; queued S236B remains report-only
...
- no selected or started ULC stage and no dependency-ready successor product
  stage after WCV-C3 because S241A remains incomplete; queued S236B remains a
  report-only non-product control lane;
