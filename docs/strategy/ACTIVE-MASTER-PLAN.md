...
After the WCV-C3 receipt there is no dependency-ready successor product stage
because ULC-M1 additionally requires S241A. Queued S236B remains report-only
and cannot start from nonqualifying Draft PR #660. C2R-B installs no runtime;
