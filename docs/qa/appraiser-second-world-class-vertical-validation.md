...
Nine finding-producing exact-head Codex reviews found nineteen substantive issues;
...
19. **Malformed current S207 fail-closed validation** — cycle-6 review
    ...
    only in the immediately-before-first-byte read. Cycle 7 exact-head review is
    pending.
