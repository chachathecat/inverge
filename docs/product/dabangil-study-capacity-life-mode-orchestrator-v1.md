...
- required Plan Gap scope capped at the same 5,040-minute bound accepted by replan validation;
- weekly dates constrained to one inclusive seven-day interval;
