...
async function serve(production=false, controlledPractice=false, paidPractice=false, controlledLaw=false){
 ...
 if(controlledLaw) Object.assign(env,{INVERGE_OWNER_PC_THEORY_ENABLED:"false",INVERGE_OWNER_PC_THEORY_DEVELOPMENT_ENABLED:"false",WCV_C2R_C_T_THEORY_ENABLED:"false",WCV_C2R_C_L_LAW_ENABLED:"true",WCV_C2R_C_L_OWNER_EMAILS:email,GEMINI_API_KEY:"synthetic-law-no-live-key",GEMINI_MODEL:"gemini-2.5-flash",INVERGE_LAW_CONTROLLED_PROVIDER:"true",NODE_OPTIONS:`--import=${new URL("./law-development-provider.mjs",import.meta.url).href}`});
