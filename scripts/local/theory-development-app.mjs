...
async function serve(production=false, controlledPractice=false, paidPractice=false, controlledLaw=false, captureOnly=false){
 const c=await config();if(c.userId!==userId)fail("isolated_config_mismatch");
