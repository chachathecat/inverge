...
const problem=sourceType==="pdf"?"Original synthetic input check: Explain how ordinary market exposure differs from the seller urgent financial need when interpreting market value.":"독자 합성 입력 검증: 통상적인 시장 노출 기간과 개별 매도인의 급박한 매각 사정을 구분하여 시장가치 판단의 조건을 설명하시오.";
