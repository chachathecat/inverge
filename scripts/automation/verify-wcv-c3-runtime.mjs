...
async function runRuntime() {
  ...
  try {
    ...
    if (schema !== "true|true|true|true|5|false|false|true") throw new Error("WCV-C3 schema, forced RLS, or grants are not exact");
    ...
    const evidence = {
      ...
      assertions: ["exact_head", "two_fresh_authenticated_identities", "default_off_before_parse", "forced_rls_service_only", "migration_replay", "three_subject_browser_chain", "responsive_390_768_1440", "keyboard_and_axe", "private_body_projection_separation", "cross_user_denial", "export_delete", "process_restart_restore", "reopen_after_later_failure", "bounded_daily_plan"],
