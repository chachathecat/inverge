...
const defaultTestFiles = [
  "tests/owner-local-ocr.test.mjs",
  "tests/capture-input-separation.test.mjs",
  ...
  "tests/today-paragraph-self-rating.test.mjs",
  ...
  "tests/owner-market-relation.test.mjs",
  ...
  "tests/first-stage-owner-local-today.test.mjs",
  "tests/first-stage-owner-local-today-browser.test.mjs",
  "tests/first-stage-owner-local-curriculum.test.mjs",
  ...
  "tests/first-stage-related-law-applicability.test.mjs",
  "tests/first-stage-real-estate-applicability.test.mjs",
  "tests/first-stage-final-release.test.mjs",
  ...
  "tests/second-stage-shared-first-glance.test.mjs",
  ...
  "tests/c2r-c-p-practice-structured-proof.test.mjs",
