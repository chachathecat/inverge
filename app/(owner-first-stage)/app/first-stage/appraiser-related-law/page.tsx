...
export default async function PrivateAppraiserRelatedLawPracticePage() {
  const owner = await requirePrivateFirstStageOwner();
  if (!owner) notFound();
  return <ReviewOsAppShell email={owner.email}><FirstStagePrivatePractice subject="appraiser_related_law" /></ReviewOsAppShell>;
}
