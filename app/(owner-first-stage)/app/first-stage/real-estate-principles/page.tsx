...
export default async function PrivateRealEstatePrinciplesPracticePage() {
  const owner = await requirePrivateFirstStageOwner();
  if (!owner) notFound();
  return <ReviewOsAppShell email={owner.email}><FirstStagePrivatePractice subject="real_estate_principles" /></ReviewOsAppShell>;
}
