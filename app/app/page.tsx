        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-end">
          <div className="min-w-0">
            <header data-s232d5-today-meta>
              <p className="v3-type-caption text-[color:var(--muted)]">{REVIEW_OS_LEARNER_LANGUAGE.todayPlan} · {REVIEW_OS_LEARNER_LANGUAGE.primaryTask}</p>
                      ...
                      <article key={task.itemId} className={mode === "second"
                        ...
                        <details className={mode === "second"
                          ...
                          <div className="grid gap-2 border-t border-[color:var(--border-hairline)] px-3 py-3 text-xs leading-5 text-[color:var(--muted)]">
                            <p><span className="font-medium text-[color:var(--foreground-strong)]">{REVIEW_OS_LEARNER_LANGUAGE.biggestGap}:</span> {task.one_biggest_gap}</p>
